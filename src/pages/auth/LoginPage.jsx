  ...
  return (
    <>
      <section className='flex w-screen min-h-screen'>
        <Card className='max-w-[480px] lg:max-w-[540px] mx-auto lg:mx-0 rounded-none w-full flex flex-col gap-8 justify-center items-center p-8 z-[10] overflow-y-auto'>
